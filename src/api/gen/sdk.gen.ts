...
import type { GetApiOauthAuthData, GetApiOauthSignoutData, GetApiRequestsData, GetApiRequestsResponse, GetApiRequestsError, PostApiRequestsData, PostApiRequestsError, DeleteApiRequestsSelfData, DeleteApiRequestsSelfError, GetApiRequestsSelfData, GetApiRequestsSelfResponse, GetApiRequestsSelfError, PostApiRequestsSelfData, PostApiRequestsSelfError } from './types.gen';
...
export const deleteApiRequestsSelf = <ThrowOnError extends boolean = false>(options?: Options<DeleteApiRequestsSelfData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<unknown, DeleteApiRequestsSelfError, ThrowOnError>({
